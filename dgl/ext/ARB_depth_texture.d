module dgl.ext.ARB_depth_texture;
import dgl.OpenGL;
import dgl.GLExt;
...
private ushort extensionId__ = 318;
alias extensionId__ ARB_depth_texture;
...
version (all) {
	...
	private void*[] loadFunctions__(GL gl) {
		void*[] funcAddr = new void*[1];
		{
			...
			if (!extStr.containsPattern("GL_ARB_depth_texture")) { funcAddr[0] = null; return funcAddr; }
		}
