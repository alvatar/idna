module dgl.ext.ARB_texture_compression_rgtc;
import dgl.OpenGL;
import dgl.GLExt;
...
private ushort extensionId__ = 137;
alias extensionId__ ARB_texture_compression_rgtc;
...
version (all) {
	...
	private void*[] loadFunctions__(GL gl) {
		void*[] funcAddr = new void*[1];
		{
			...
			if (!extStr.containsPattern("GL_ARB_texture_compression_rgtc")) { funcAddr[0] = null; return funcAddr; }
		}
