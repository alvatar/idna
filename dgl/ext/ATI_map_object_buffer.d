...
version (all) {
	...
	private {
		extern (System) {
			alias void* function (GLuint buffer)	fp_glMapObjectBufferATI;
			alias void function (GLuint buffer)	fp_glUnmapObjectBufferATI;
		}
	}
	public {
...
void UnmapObjectBuffer(GL gl_, ParameterTypeTuple!(fp_glUnmapObjectBufferATI) params__) {
	...
	private void*[] loadFunctions__(GL gl) {
		void*[] funcAddr = new void*[2];
		{
			...
			if (!extStr.containsPattern("GL_ATI_map_object_buffer")) { funcAddr[0] = null; return funcAddr; }
		}
		if (null is (funcAddr[0] = getExtensionFuncPtr(cast(char*)"glMapObjectBufferATI"))) { funcAddr[0] = null; return funcAddr; }
		if (null is (funcAddr[1] = getExtensionFuncPtr(cast(char*)"glUnmapObjectBufferATI"))) { funcAddr[0] = null; return funcAddr; }
		return funcAddr;
	}
}
