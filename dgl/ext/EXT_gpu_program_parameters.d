...
version (all) {
	...
	private {
		extern (System) {
			alias void function (GLenum target, GLuint index, GLsizei count,  GLfloat* params)	fp_glProgramEnvParameters4fvEXT;
			alias void function (GLenum target, GLuint index, GLsizei count,  GLfloat* params)	fp_glProgramLocalParameters4fvEXT;
		}
	}
	public {
...
void ProgramLocalParameters4fv(GL gl_, ParameterTypeTuple!(fp_glProgramLocalParameters4fvEXT) params__) {
	...
	private void*[] loadFunctions__(GL gl) {
		void*[] funcAddr = new void*[2];
		{
			...
			if (!extStr.containsPattern("GL_EXT_gpu_program_parameters")) { funcAddr[0] = null; return funcAddr; }
		}
		if (null is (funcAddr[0] = getExtensionFuncPtr(cast(char*)"glProgramEnvParameters4fvEXT"))) { funcAddr[0] = null; return funcAddr; }
		if (null is (funcAddr[1] = getExtensionFuncPtr(cast(char*)"glProgramLocalParameters4fvEXT"))) { funcAddr[0] = null; return funcAddr; }
		return funcAddr;
	}
}
