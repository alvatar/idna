module dgl.ext.EXT_packed_depth_stencil;
import dgl.OpenGL;
import dgl.GLExt;
...
private ushort extensionId__ = 233;
alias extensionId__ EXT_packed_depth_stencil;
...
version (all) {
	...
	private void*[] loadFunctions__(GL gl) {
		void*[] funcAddr = new void*[1];
		{
			...
			if (!extStr.containsPattern("GL_EXT_packed_depth_stencil")) { funcAddr[0] = null; return funcAddr; }
		}
