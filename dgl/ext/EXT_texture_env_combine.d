module dgl.ext.EXT_texture_env_combine;
import dgl.OpenGL;
import dgl.GLExt;
...
private ushort extensionId__ = 314;
alias extensionId__ EXT_texture_env_combine;
...
version (all) {
	...
	private void*[] loadFunctions__(GL gl) {
		void*[] funcAddr = new void*[1];
		{
			...
			if (!extStr.containsPattern("GL_EXT_texture_env_combine")) { funcAddr[0] = null; return funcAddr; }
		}
