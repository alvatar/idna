module dgl.ext.WGL_ARB_pixel_format_float;
import dgl.OpenGL;
import dgl.GLExt;
...
private ushort extensionId__ = 11;
alias extensionId__ WGL_ARB_pixel_format_float;
...
version (Windows) {
	public {
			const GLenum WGL_TYPE_RGBA_FLOAT_ARB = 0x21A0;
	}
	private {
		extern (System) {
		}
...
import dgl.ext.WGL_EXT_extensions_string : wglGetExtensionsString, WGL_EXT_extensions_string;
	private void*[] loadFunctions__(GL gl) {
		void*[] funcAddr = new void*[1];
		{
			...
			if (!extStr.containsPattern("WGL_ARB_pixel_format_float")) { funcAddr[0] = null; return funcAddr; }
		}
