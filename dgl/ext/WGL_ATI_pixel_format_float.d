module dgl.ext.WGL_ATI_pixel_format_float;
import dgl.OpenGL;
import dgl.GLExt;
...
alias extensionId__ WGL_ATI_pixel_format_float;
...
version (Windows) {
	public {
			...
			const GLenum GL_RGBA_FLOAT_MODE_ATI = 0x8820;
			const GLenum GL_COLOR_CLEAR_UNCLAMPED_VALUE_ATI = 0x8835;
	}
	private {
		extern (System) {
		}
...
import dgl.ext.WGL_EXT_extensions_string : wglGetExtensionsString, WGL_EXT_extensions_string;
	private void*[] loadFunctions__(GL gl) {
		void*[] funcAddr = new void*[1];
		{
			...
			if (!extStr.containsPattern("WGL_ATI_pixel_format_float")) { funcAddr[0] = null; return funcAddr; }
		}
