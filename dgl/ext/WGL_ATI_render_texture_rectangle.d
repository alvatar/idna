module dgl.ext.WGL_ATI_render_texture_rectangle;
import dgl.opengl;
import dgl.glext;
...
private ushort extensionId__ = 79;
alias extensionId__ WGL_ATI_render_texture_rectangle;
...
version (Windows) {
	public {
			const GLenum WGL_TEXTURE_RECTANGLE_ATI = 0x21A5;
	}
	private {
		extern (System) {
		}
...
import dgl.ext.WGL_EXT_extensions_string : wglGetExtensionsString, WGL_EXT_extensions_string;
	private void*[] loadFunctions__(GL gl) {
		void*[] funcAddr = new void*[1];
		{
			...
			if (!extStr.containsPattern("WGL_ATI_render_texture_rectangle")) { funcAddr[0] = null; return funcAddr; }
		}
