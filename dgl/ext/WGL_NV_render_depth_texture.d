module dgl.ext.WGL_NV_render_depth_texture;
import dgl.OpenGL;
import dgl.GLExt;
...
private ushort extensionId__ = 123;
alias extensionId__ WGL_NV_render_depth_texture;
import dgl.ext.SGIX_depth_texture;
...
import dgl.ext.WGL_EXT_extensions_string : wglGetExtensionsString, WGL_EXT_extensions_string;
	private void*[] loadFunctions__(GL gl) {
		void*[] funcAddr = new void*[1];
		{
			...
			if (!extStr.containsPattern("WGL_NV_render_depth_texture")) { funcAddr[0] = null; return funcAddr; }
		}
