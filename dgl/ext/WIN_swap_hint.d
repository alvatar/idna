...
version (all) {
	...
	private {
		extern (System) {
			alias void function (GLint x, GLint y, GLsizei width, GLsizei height)	fp_glAddSwapHintRectWIN;
		}
	}
	public {
void AddSwapHintRect(GL gl_, ParameterTypeTuple!(fp_glAddSwapHintRectWIN) params__) {
	...
	private void*[] loadFunctions__(GL gl) {
		void*[] funcAddr = new void*[1];
		{
			...
			if (!extStr.containsPattern("GL_WIN_swap_hint")) { funcAddr[0] = null; return funcAddr; }
		}
		if (null is (funcAddr[0] = getExtensionFuncPtr(cast(char*)"glAddSwapHintRectWIN"))) { funcAddr[0] = null; return funcAddr; }
		return funcAddr;
	}
}
